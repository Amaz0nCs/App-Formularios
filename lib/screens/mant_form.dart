    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          ...
          TextButton(
            onPressed: () {
              // Si ya estás en la pantalla de Mantenimiento, no hacer nada
            },
            child: Text(
              'Mantenimiento',
              style: TextStyle(
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    ...
                    // Aquí puedes agregar la lógica de consulta de mantenimiento
                  },
                ...
                ElevatedButton(
                  onPressed: () {
                    ...
                    // Aquí puedes agregar la lógica para registrar mantenimiento
                  },
